    ...
    <div className="fixed inset-0 z-1000 mt-0! grid place-items-center overflow-auto bg-opacity-10 backdrop-blur-sm">
      <div className="w-11/12 max-w-87.5 rounded-lg border border-richblack-400 bg-richblack-800 p-6">
        ...
        <div className="flex items-center gap-x-4">
          ...
          <button className='cursor-pointer rounded-md bg-richblack-200 py-2 px-5 font-semibold text-richblack-900' onClick={modalData.btn2Handler}>{modalData?.btn2Text} </button>
        </div>
      </div>
    </div>
  )
