    ...
    <>
      <div className='text-3xl text-richblack-50'>Enrolled Courses</div>
      {
        !enrolledCourses ? (
          ...
          <p className="grid h-[10vh] w-full place-content-center text-richblack-5">No course yet</p>
        ) : (
            ...
            {/* courses Name */}
            {
              ...
              key={i}>
                  ...
                  <div className="flex w-1/5 flex-col gap-2 px-2 py-3">
                    <p className="flex w-1/5 flex-col gap-2 px-2 py-3">Progress:{course.progressPercentage || 0}%</p>
                    <ProgressBar
