...
const VideoDetails = () => {
  ...
  const isLastVideo = () =>{
    ...
    if(currentSectionIndx === noOfSubsections - 1 && currentSubSectionIndx === noOfSubsections -1 ){
      return true 
  ...
  const goToNextVideo = () =>{
    ...
    if(currentSubSectionIndx !== noOfSubsections -1  ){
       ...
       navigate(`/view-course/${courseId}/sectionId/${sectionId}/subSectionId/${nextSubSectionId}`)
    }else{
      const nextSectionId = courseSectionData[currentSectionIndx + 1]._id
      const nextSubSectionId = courseSectionData[currentSectionIndx + 1].subSection[0]._id

      navigate(`/view-course/${courseId}/sectionId/${nextSectionId}/subSectionId/${nextSubSectionId}`)
    }
